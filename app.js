...
App({
    ...
    formatDate: function (milliseconds) {
        ...
        if (year == (new Date().getYear() + 1900)) {
            ...
            return (month < 10 ? '0' + month : month) + "-" + (day < 10 ? '0' + day : day) + " " + hours + ":" + minutes + ":" + seconds;
        } else {
   ...
   /* onHide: function () {
    ...
    globalData: {
        ...
        tourismListSent: null,
        tourismListReceived: null,
        adminPrivMsgsSent: null,
        adminPrivMsgsReceived: null,
        beRepliedContent: null,
        toBeRemovedTopicId: null,
        //serverHost: "http://localhost:9099",
        serverHost: "https://currycgo.com"
        //serverHost: "https://nasuf.cn"
    }
})